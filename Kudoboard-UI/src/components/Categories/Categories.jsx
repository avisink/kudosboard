...
function Categories ({setCategory, setRecentSort, category, recentSort, refreshTrigger, onBoardCreated}) {
    ...
    return (
        ...
        {showModal && <CreateBoardModal onClose={() => setShowModal(false)} onBoardCreated={onBoardCreated} />}
        </>
    );
};
